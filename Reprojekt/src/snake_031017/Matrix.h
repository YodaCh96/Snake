...
#define LED_RED 1
  ...
  int temp;			//FC<r die Ausgabe der letzter LED-Reihe
...
{
  for (int n = 1; n < MaxSpalte; n += 2)
    {				//For schleife zum Setzten einer Reihe mir roter Farbe
...
{
  for (int z = 0; z < MaxSpalte; z += 2)
    {				//For schleife zum Setzten einer Reihe mit gruener Farbe
      digitalWrite (ShiftPinR, LOW);
